...
const Projects = () => {
    ...
    const projectStyle = 'h-60 w-40 py-20 border-4 border-zinc-800  text-center rounded-2xl bg-zinc-400 hover:bg-zinc-600 font-bold text-white'
    ...
    return(
        <div className="projects-container" class='my-20'>
            ...
            <div className="projects" class='flex justify-around w-3/4 mx-auto '>
